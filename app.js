const stories={feature:['AI 시대의 창작, 좋은 질문에서 시작된다.','생성형 AI에 처음 요청한 것은 “멋진 이미지를 만들어 줘”라는 짧은 문장이었다. 결과는 화려했지만, 내가 전하고 싶은 이야기는 분명하지 않았다.','그다음에는 대상을 정하고, 표현할 감정과 재료를 구체화했다. 따뜻한 빛, 차가운 금속, 고요한 구도. 질문이 선명해질수록 선택의 기준도 분명해졌다.','이번 실습에서 배운 것은 좋은 결과를 고르는 일 역시 창작이라는 점이다. AI가 제안한 결과를 그대로 받아들이기보다, 의도와 맞는지 살피고 수정하는 과정이 필요했다.'],prompt:['한 문장의 차이가 만드는 전혀 다른 결과','“글을 써 줘” 대신 독자, 목적, 분량을 정했다. 같은 주제여도 교육생을 위한 학습 노트와 처음 기술을 접하는 독자를 위한 기사는 달라야 했다.','요청을 구체화하는 순서는 목적, 맥락, 제약 조건, 확인 기준이다. 결과가 부족하면 모든 문장을 바꾸기보다 하나의 조건씩 수정하며 차이를 관찰했다.'],data:['데이터를 이야기로 바꾸는 연습','많은 숫자를 보여 주는 것만으로 이야기가 만들어지지는 않았다. 먼저 자료의 출처와 범위를 확인하고, 독자가 해결하려는 질문을 한 문장으로 적었다.','그다음 비교 기준과 예외를 구분했다. 관찰한 사실과 나의 해석을 나누어 적는 것만으로도 글의 논리가 더 분명해졌다.'],concept:['보이지 않는 생각을 어떻게 표현할까?','주제: 아이디어가 구체화되는 순간. 차가운 금속과 따뜻한 돌을 대비해 추상적인 생각이 손에 잡히는 결과로 바뀌는 느낌을 표현한다.','화면은 느리게 움직이고 색은 최소화한다. 장면마다 새로운 소재를 더하기보다 같은 사물을 다른 거리와 빛으로 보여 주는 방향으로 기획했다.'],motion:['생각이 형태가 되는 순간 — 스토리보드','00–08초 / 어두운 공간에 가느다란 빛이 들어온다. 금속의 가장자리가 드러나며 새로운 생각의 시작을 표현한다.','08–22초 / 크롬 조형물의 질감에서 검은 구와 돌의 표면으로 시선을 옮긴다. 재료 간 대비로 실험과 탐구의 과정을 보여 준다.','22–30초 / 카메라가 뒤로 이동하며 전체 정물 구도가 드러난다. 마지막에 프로젝트 제목과 함께 마무리한다.','현재는 임시 기획 샘플이며, 재생할 실제 영상 파일은 아직 등록되지 않았습니다.']};
